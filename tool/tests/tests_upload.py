...
class UploadTests(TestCase):
    ...
    def test_multiple_upload_replaces(self):
        authenticate_admin(self)
        create_db_props()
        test_upload(self, 'upload_test_valid.csv', None)
        validate_valid_data(self, False)
    ...
    def test_upload_invalid_attendance_data(self):
        ...
        test_upload(self, 'upload_test_invalid.csv',
                    'Error with inputs: [[Unrecognised attendance value for 10519C: yes at column 1, Unrecognised attendance value for 10519C: no at column 4]] at line 2')
